...
Scenario:  Deseo ingresar a la aplicación, ver la lista de paginas,  crear una pagina, publicarla e ir a la URL de la nueva pagina para validar que este publicada
    ...
    And I enter password "<PASSWORD>" into selector "input[name='password']"
    And I push login button with selector "button[type='submit']"
    And I take screenshot of step "1" and scenario "<ESCENARIO_10>" and feature "Paginas" and version "<GHOST-VERSION-2>"
    And I wait for 2 seconds
    And I expect to enter to Ghost home page "<GHOST-VERSION-2-URL2>"
    And I click on Pages list with selector "a[href='#/pages/']"
    And I expect to enter to Ghost Pages section "<GHOST-VERSION-2-URL5>"
    And I take screenshot of step "2" and scenario "<ESCENARIO_10>" and feature "Paginas" and version "<GHOST-VERSION-2>"
    And I wait for 1 seconds
    And I click on New Page with selector "a[href='#/editor/page/']"
    And I wait for 1 seconds
    And I take screenshot of step "3" and scenario "<ESCENARIO_10>" and feature "Paginas" and version "<GHOST-VERSION-2>"
    And I enter Page Title "$name_2" into selector "textarea[placeholder='Page title']"
    And I enter Page content "$string_1" "$string_2" "$string_3" into selector "div[data-placeholder='Begin writing your page...']"
    And I wait for 1 seconds
    And I take screenshot of step "4" and scenario "<ESCENARIO_10>" and feature "Paginas" and version "<GHOST-VERSION-2>"
    And I click on Publish with selector "div[tabindex='0']"
    And I wait for 5 seconds
    And I take screenshot of step "5" and scenario "<ESCENARIO_10>" and feature "Paginas" and version "<GHOST-VERSION-2>"
    And I push Publish button with selector "button[class='gh-btn gh-btn-black gh-publishmenu-button gh-btn-icon ember-view']"
    And I wait for 5 seconds
    Then I go to published page in "<GHOST-VERSION-2-URL6>" "$$name_2"
    And I wait for 1 seconds
    And I expect to stay on published page "<GHOST-VERSION-2-URL6>" "$$name_2"
    And I take screenshot of step "6" and scenario "<ESCENARIO_10>" and feature "Paginas" and version "<GHOST-VERSION-2>"
    And I wait for 2 seconds
